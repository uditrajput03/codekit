        ...
        <div className="flex justify-center">
            <div className="flex flex-col gap-2 max-w-xl justify-center items-center text-sm text-gray-600 sm:p-8">
                ...
                <div className="flex justify-center items-center max-w-xl sm:px-20">
                    <input type="text" name="email" placeholder="you@example.com" required="" className=" p-2 mx-1 sm:min-w-full bg-mauve-light-3 text-mauve-light-12 placeholder:text-mauve-light-11 " value="" />
